...
router.put('/edit-collection/:collectionId',adminController.editCollection)
...
router.delete('/delete-collection/:collectionId',adminController.deleteCollection)
...
in the application. */
router.put('/edit-banner/:bannerId',adminController.editBanner)
